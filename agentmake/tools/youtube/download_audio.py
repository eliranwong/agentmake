...
from toolmate import showErrors, isCommandInstalled, is_valid_url, downloadWebContent, find_last_added_file
...
def download_youtube_audio(function_args):
    ...
    def terminalDownloadYoutubeFile(downloadCommand, url_string, outputFolder):
        if isFfmpegInstalled():
            ...
            print("Read https://github.com/eliranwong/letmedoit/wiki/Install-ffmpeg")
