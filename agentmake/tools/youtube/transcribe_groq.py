...
TOOL_SCHEMA = {
    "name": "transcribe_youtube_audio_groq",
    "description": "Transcribe YouTube video into text with Groq service",
    "parameters": {
        "type": "object",
        "properties": {
            "url": {
...
def transcribe_youtube_audio_groq(url: str="", **kwargs):
...
TOOL_FUNCTION = transcribe_youtube_audio_groq