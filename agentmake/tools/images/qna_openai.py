...
def examine_images_openai(query: str, image_filepath: Union[str, list], **kwargs):
    ...
    if content:
        ...
        response = client.chat.completions.create(
            model=os.getenv("OPENAI_VISUAL_MODEL") if os.getenv("OPENAI_VISUAL_MODEL") else "gpt-4o",
            messages=[
                {
                "role": "user",
                "content": content,
...
TOOL_FUNCTION = examine_images_openai
