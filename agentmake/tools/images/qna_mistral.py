...
def examine_images_mistral(query: str, image_filepath: Union[str, list], **kwargs):
    ...
    from agentmake import MistralAI
    import os
...
TOOL_FUNCTION = examine_images_mistral
